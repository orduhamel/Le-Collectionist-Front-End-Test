...
<script>
const tabs = [
  { name: 'Tous', href: '/films', current: true },
  { name: 'Action', href: '/films/action', current: false },
  { name: 'Animation', href: '/films/animation', current: false },
  { name: 'Aventure', href: '/films/aventure', current: false },
  { name: 'Comédie', href: '/films/comedie', current: false },
  { name: 'Documentaire', href: '/films/documentaire', current: false },
]
